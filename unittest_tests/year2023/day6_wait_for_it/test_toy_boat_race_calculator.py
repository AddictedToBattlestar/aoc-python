...
from src.year2023.day6_wait_for_it.toy_boat_race_calculator import get_values, get_min_button_time, get_max_button_time, \
...
class Test(TestCase):
    ...
    def test_get_total_number_of_ways_to_win_from_file(self):
        sample_data_test_file = PROJECT_ROOT + "/year2023/day6_wait_for_it/day6_sample_data.txt"
