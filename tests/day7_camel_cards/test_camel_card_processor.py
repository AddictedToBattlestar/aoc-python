...
from src.day7_camel_cards.camel_card_calculator import GeneralHandRanking
from src.day7_camel_cards.camel_card_processor import CamelCardBid, order_bids_by_value_of_hand, \
...
class TestCamelCardBid(TestCase):
    ...
    def test_processing_from_file(self):
        sample_data_test_file = PROJECT_ROOT + "/day7_camel_cards/day7_sample_data.txt"
    ...
    def test_processing_from_file_example2(self):
        sample_data_test_file = PROJECT_ROOT + "/day7_camel_cards/day7_sample_data2.txt"
        total_winnings = get_total_winnings_from_file(sample_data_test_file)
