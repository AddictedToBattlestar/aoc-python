...
from src.day5_seed_fertilizer.seeding_location_mapper import SeedingLocationMapper, SeedingMap, SeedingCategoryProcessor, \
...
class TestSeedingCategoryProcessor(TestCase):
    ...
    def test_calculate_from_file(self):
        sample_data_test_file = PROJECT_ROOT + "/day5_seed_fertilizer/day5_sample_data.txt"
