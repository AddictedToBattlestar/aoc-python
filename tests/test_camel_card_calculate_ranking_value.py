...
from day7_camel_cards.camel_card_calculator import GeneralHandRanking, calculate_ranking_value

'''
Ranking notes:
GeneralHandRanking * 100 + HighestCardRanking_FirstMatch + HighestCardRanking_FirstMatch
