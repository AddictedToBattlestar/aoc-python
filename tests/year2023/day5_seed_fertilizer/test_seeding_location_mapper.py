...
from src.year2023.day5_seed_fertilizer.seeding_location_mapper import SeedingLocationMapper, SeedingMap, SeedingCategoryProcessor, \
...
class TestSeedingCategoryProcessor(TestCase):
    ...
    def test_calculate_from_file(self):
        sample_data_test_file = PROJECT_ROOT + "/year2023/day5_seed_fertilizer/day5_sample_data.txt"
        self.assertEqual(35, calculate_from_file(sample_data_test_file))
    ...
    def test_calculate_from_file_using_seed_number_revisions(self):
        sample_data_test_file = PROJECT_ROOT + "/year2023/day5_seed_fertilizer/day5_sample_data.txt"
        self.assertEqual(46, calculate_from_file(file_name=sample_data_test_file,
