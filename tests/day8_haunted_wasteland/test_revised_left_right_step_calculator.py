...
from src.day8_haunted_wasteland.revised_left_right_step_calculator import calculate, calculate_from_file
...
class Test(TestCase):
    ...
    def test_calculate_from_file(self):
        sample_data_test_file = PROJECT_ROOT + "/day8_haunted_wasteland/day8_data_sample.txt"
