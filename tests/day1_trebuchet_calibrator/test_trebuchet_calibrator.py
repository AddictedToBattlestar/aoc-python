...
from src.day1_trebuchet_calibrator.trebuchet_calibrator import get_calibration_value, calculate, calculate_from_file
...
class TestTrebuchetCalibrator(TestCase):
    ...
    def test_calculate_from_file(self):
        sample_data_test_file = PROJECT_ROOT + "/day1_trebuchet_calibrator/day1-part1-sample-data.txt"
        self.assertEqual(142, calculate_from_file(file_name=sample_data_test_file))

    def test_calculate_from_file_part2(self):
        sample_data_test_file = PROJECT_ROOT + "/day1_trebuchet_calibrator/day1-part2-sample-data.txt"
